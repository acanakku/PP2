    ...
    class CarSprite(pygame.sprite.Sprite):
        ...
        def update(self, deltat):
            ...
            if self.position[0] < 0:
                self.position = (0, self.position[1])  # Установка X на минимальное значение
                self.speed = 0  # Остановка машины

            elif self.position[0] > W:
                self.position = (W, self.position[1])  # Установка X на максимальное значение
                self.speed = 0  # Остановка машины

            if self.position[1] < 0:
                self.position = (self.position[0], 0)  # Установка Y на минимальное значение
                self.speed = 0  # Остановка машины

            elif self.position[1] > H:
                self.position = (self.position[0], H)  # Установка Y на максимальное значение
                self.speed = 0  # Остановка машины
